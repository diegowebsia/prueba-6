 ...
 * ============================================================
 * Google Business, Google Places, Trustpilot y la API pública comparten
 * este único camino para que el corte de cuota sea idéntico en los cuatro:
...
export async function ingestReviews(
  ...
  source: 'google' | 'trustpilot' | 'facebook' | 'manual' | 'places',
...
/** Helper para rutas: cuerpo JSON estándar de un gate bloqueado. */
export function gateBody(gate: GateBlocked): Record<string, unknown> {
  return gate.body;
}
