...
import { DEFAULT_AI_MODEL, estimateCostUsd } from '@/lib/plans';
...
const ZERO_USAGE = (provider: AiUsage['provider'], errorCode?: string | null): AiUsage => ({
...
export async function generateReplyForTenant(
  ctx: AiContext,
  input: RespondInput,
  options: { feature?: PlanFeaturesKey } = {},
